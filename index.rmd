...
In our paper in *Epidemiology* (2017; 28(1): 12-19) we proposed a model for survival data that acknowledges that death may be caused by several diseases acting together, by considering all the diseases mentioned on the death certificate. This way we can estimate burden-of-disease indicators and epidemiological association parameters in a way that better reflects the contribution of each disease to mortality. This is particularly important for chronic and degenerative diseases.
